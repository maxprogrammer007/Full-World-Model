...
def preprocess_state(state, device):
    ...
    state = state.permute(2, 0, 1)  # HWC -> CHW
...
env = wrappers.RecordVideo(
    ...
    name_prefix='world_model_eval',       # Video files will be like world_model_eval-episode-0.mp4
...
print("Evaluation completed. Videos saved in ./videos folder.")